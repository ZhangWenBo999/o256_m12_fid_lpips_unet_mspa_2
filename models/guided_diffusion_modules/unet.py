...
# from module_test.bing_sigmoid import *
# from module_test.MultiScaleFeatureFuse import *
# from module_test.mlla_attnres_e2 import *
# from module_test.SCSA_e2 import *
# from module_test.MultiLevelSCSA import *
# from module_test.DepthwiseSeparableConv import *
# from module_test.msssa import *

from module_test.b17_MSPA import *
# from module_test.b17_MSPA_1 import *
# from module_test.b16_IDC import *
...
# from module_test.a6_CRA import *
# from module_test.a21_PCon import *
# from module_test.MultiLevelSCSA_scaler3579_gn1 import *
# from module_test.MultiLevelSCSA_scaler3579_gn4_drop02 import *
...
#
# import sys
# sys.path.append('/home/zwb/zwb/code/256_fid_lpips_linux_b_sigmoid/o256_m12_fid_lpips')
#
# from module_test.bing_sigmoid import *
# from module_test.MultiScaleFeatureFuse import *
...
class Upsample(nn.Module):
    ...
    def __init__(self, channels, use_conv, out_channel=None):
        ...
        # self.upsample_Lp = DySample_UP(in_channels=channels, scale=2, style='pl')
...
class ResBlock(EmbedBlock):
    ...
    def __init__(
        ...
        self.in_layers = nn.Sequential(
            ...
            # DWConv3_5_cat(channels, self.out_channel)
        )
        ...
        self.out_layers = nn.Sequential(
            ...
            zero_module(
                ...
                # Partial_conv3(self.out_channel, 2, 'split_cat')
                # DepthwiseSeparableConv2d(self.out_channel, self.out_channel, 3)
                # DWConv3_5_cat(self.out_channel, self.out_channel)
            ),
        )
            ...
            for _ in range(res_blocks):
                ...
                if ds in attn_res:
                    layers.append(
                        ...
                        MSPAModule(inplanes=32, scale=4)
                        # MKLAttention(ch)
                        ...
                        # nn.Sequential(
                        # MultiScaleFeatureFusion(dim=ch),
                        # CBAM(ch))
